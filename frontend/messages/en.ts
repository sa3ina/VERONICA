export default {
  ...
  auth: { welcome: 'Welcome back', loginTitle: 'Sign in to your account', registerTitle: 'Create a new account' },
  dashboard: { title: 'Operations dashboard', subtitle: 'Live flow, risk, and smart recommendations in one place.' }
};
